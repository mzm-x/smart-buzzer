<?php
// Smart Buzzer - Thank You Page B1G1 V2 (v3.1)
// Fires Purchase pixel + dataLayer push on page load
// Supports Fanbasis redirect params AND legacy params (pkg/dest/biz)

// Package details
$packages = [
    'booster'   => ['name' => 'Booster',   'reviews' => '65',  'price' => '380.00', 'display' => '$380', 'item_id' => 'pkg_booster_65',    'item_name' => 'Buy Google Reviews - 65 Local (B1G1)'],
    'dominator' => ['name' => 'Dominator', 'reviews' => '120', 'price' => '680.00', 'display' => '$680', 'item_id' => 'pkg_dominator_120', 'item_name' => 'Buy Google Reviews - 120 Local (B1G1)']
];
...
$safeDest = filter_var($legacyDest, FILTER_VALIDATE_URL) ? $legacyDest : 'https://smart-buzzer.com/promo-b1g1/';
?>
<!DOCTYPE html>
<html lang="en">
<head>
